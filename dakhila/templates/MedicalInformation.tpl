...
<div class="section">Emergency Contact (Other than Parents)</div>
<table>
<thead>
...
<div class="section">Health Care Providers</div>
<table>
<thead>
...
<div class=explanation>Please write explanation of any medical condition here that might be useful in an emergency. </div>
