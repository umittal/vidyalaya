...
<li class="section">Medical Information </li>
<table>
<thead>
...
<li class="section">Explanation</li>
<p>Please write explanation of any medical condition here that might be useful in an emergency. 
</ol>
